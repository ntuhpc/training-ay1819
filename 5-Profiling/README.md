...
- Remote script: An optional script to be run before starting the remote daemon on the remote system. This can be used to load required modules for DDT and MAP, your MPI and compiler.
...
# Performance Report 
Video Tutorial: https://developer.arm.com/products/software-development-tools/hpc/arm-performance-reports/video-demos-and-tutorials <br>
User Guide: https://www.osc.edu/sites/default/files/documentation/userguide-reports.pdf<br>

## Example
```
export PATH=/opt/arm/reports/bin:${PATH}
export Arm_NO_TIMEOUT=1 #disable timeout, because perf-report needs long time to initialise.
Arm_NOTES="Some notes you wanna write in report" perf-report mpiexec -hosts athena0,athena1 -ppn 2 openmc
```
There will be a html and a txt file generated in the same folder. 
